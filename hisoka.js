...
ownerNumber = ["6281319944917@s.whatsapp.net"] // ganti ke no lu, jan apus @s.whatsapp.net nya?
	   ...
	   case 'play':{
		  ...
		  break
                          ...
                          modelmenu = "image"
                            ...
                            break
	    case 'sc': {
	    m.reply('Script By Dika Ardnt , Recode By FZX Ch. Link : https://youtube.com/channel/UCIO5jgdnY1Cb6zOLpXQaChg')
            }
            break
...
hisoka.sendMessage(m.chat, {text: 'Link Terdeteksi, Kik Mint!'}, {quoted: troli})
